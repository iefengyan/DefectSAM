...
```
# Acknowledgement
We would like to acknowledge the contributions of public projects, such as [SAM-Adapter-PyTorch](https://github.com/tianrun-chen/SAM-Adapter-PyTorch), whose code has been utilized in this repository.
