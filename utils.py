...
#
#             metric_FM.step(pred=pred, mvtec=true)
#             metric_WFM.step(pred=pred, mvtec=true)
#             metric_SM.step(pred=pred, mvtec=true)
#             metric_EM.step(pred=pred, mvtec=true)
#             metric_MAE.step(pred=pred, mvtec=true)
#
...
#             mvtec = np.uint8(gt_float * 255)
#
#             pred_float_ = np.where(pred > min(1.5 * np.mean(pred), 255), np.ones_like(pred_float),
#                                    np.zeros_like(pred_float))
#             gt_float_ = np.where(mvtec > min(1.5 * np.mean(mvtec), 255), np.ones_like(pred_float),
#                                  np.zeros_like(pred_float))
#
