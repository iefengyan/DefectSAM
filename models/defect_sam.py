...
#         self.attn = CrossAttention_Encoder(dim=dim, num_heads=4)
...
#             attn = self.attn(q=self.query_norm(query), k=self.feat_norm(feat), v=self.feat_norm(feat))
#             return query + self.gamma * attn
#
#         query = _inner_forward(query, feat)
#
#         return query.transpose(1,2).view(b, c, h, w)
#
#
# class FAM(nn.Module):
#     def __init__(self, inplanes=128, outplanes=128):
#         super().__init__()
#
#         #
#         self.conv1 = nn.Sequential(
...
#         h,w=low.size()[2:]
#         low = self.conv1(low)
#         high = nn.functional.interpolate(high, size=(h, w), mode="bilinear")
#
#         return self.fuse_conv(high+low)
# # from .aff_blocks import AFFBlock
# @register('sam')
# class SAM(nn.Module):
#     def __init__(self, inp_size=None, encoder_mode=None, loss=None,down_channel=128):
#         super().__init__()
...
#
#         self.neck2 = nn.Sequential(
#             nn.Conv2d(64, down_channel, kernel_size=1, bias=False),
#             LayerNorm2d(down_channel),
#             nn.GELU(),
#             nn.Conv2d(down_channel, down_channel, kernel_size=3, padding=1, bias=False, ),
#             LayerNorm2d(down_channel),
...
#         self.maskattn1 = MaskAttention(dim=down_channel)
#         self.maskattn2 = MaskAttention(dim=down_channel)
#         # self.fam1  = FAM(inplanes=down_channel)
#         # self.fam2 = FAM(inplanes=down_channel)
#
#         self.out_size = 384
#         self.spm = SpatialPriorModule(inplanes=16, embed_dim=down_channel)
#         self.msgm2 = MSGM(down_channel)
#         self.msgm3 = MSGM(down_channel)
#         self.msgm4 = MSGM(down_channel)
#         # self.injector2 = Injector(down_channel)
#         # self.injector3 = Injector(down_channel)
#         # self.injector4 = Injector(down_channel)
#         # self.add2 = ADDM(down_channel)
#         # self.add3 = ADDM(down_channel)
#         # self.add4 = ADDM(down_channel)
#
#         self.linearrr1 = nn.Conv2d(down_channel, 1, kernel_size=3, stride=1, padding=1)
#         self.linearrr2 = nn.Conv2d(down_channel, 1, kernel_size=3, stride=1, padding=1)
#         self.linearrr3 = nn.Conv2d(down_channel, 1, kernel_size=3, stride=1, padding=1)
...
#         for i in range(3):
#             self.pe_layers.append(PositionEmbeddingRandom(encoder_mode['prompt_embed_dim'] // 2))
#
#         self.image_embedding_sizes = (24, 48, 96)
#
#         # self.dd3 = FAM(64,64)
#         # self.dd2 = FAM(64, 32)
#         # self.dd1 = FAM(32, 32)
...
#     #     return self.pe_layer(self.image_embedding_size).unsqueeze(0)
#     def get_dense_pe(self,i) -> torch.Tensor:
#         """
#         Returns the positional encoding used to encode point prompts,
#         applied to a dense set of points the shape of the image encoding.
#
...
#             1x(embed_dim)x(embedding_h)x(embedding_w)
#         """
#         return self.pe_layers[i](self.image_embedding_sizes[i]).unsqueeze(0)
#
#     def forward(self, x):
#         bs = 1
#         # Embed prompts
...
#
#         # y = F.interpolate(x, size=(384, 384), mode='bilinear', align_corners=True)
#         c2,c3,c4,msfeat = self.spm(x)
#         # features = self.image_encoder(x)
#         #
#         # vit_features2 = self.neck2(features[1].permute(0, 3, 1, 2))
#         # vit_features3 = self.neck3(features[2].permute(0, 3, 1, 2))
#         # vit_features4 = self.neck4(features[3].permute(0, 3, 1, 2))
#         vit_features2 = self.neck2(c2)
#         vit_features3 = self.neck3(c3)
#         vit_features4 = self.neck4(c4)
#
#         vit_features4 = self.msgm4(vit_features4, msfeat)
#         vit_features3 = self.msgm3(vit_features3, msfeat)
#         vit_features2 = self.msgm2(vit_features2, msfeat)
...
#         # d1 = self.dd1(c1,d2)
#
#         mask_11 = self.linearrr1(vit_features4)
#         mask_12 = self.linearrr2(vit_features3)
#         mask_13 = self.linearrr3(vit_features2)
#
#         # mask_11 = self.postprocess_masks(mask_11, out_size=(self.out_size, self.out_size))
#         # mask_12 = self.postprocess_masks(mask_12, out_size=(self.out_size, self.out_size))
#         # mask_13 = self.postprocess_masks(mask_13, out_size=(self.out_size, self.out_size))
#         # return [mask_13,mask_12,mask_11]
#
#         mask1, iou_predictions1 = self.mask_decoder(
#             image_embeddings=self.UpCon1x1_1(vit_features4),
#             image_pe=self.get_dense_pe(0),
#             sparse_prompt_embeddings=sparse_embeddings,
#             dense_prompt_embeddings=dense_embeddings,
#             multimask_output=False,
#         )
...
#
#
#         return  [mask3,mask2, mask1, mask_11, mask_12, mask_13]
#         # return [mask1]
#         # return [main_mask]
#
#     def postprocess_masks(
