...
from models.mmseg.models.sam import MaskDecoder,TwoWayTransformer
...
class MaskDecoderHQ(MaskDecoder):
    def __init__(self, model_type="vit_b"):
        ...
        checkpoint_dict = {"vit_b": "D:\yanfeng\sam\pretrained\sam_vit_b_maskdecoder.pth",
    ...
    def forward(
        ...
        masks_sam = mask[:, mask_slice]

        masks_hq = mask[:, slice(self.num_mask_tokens - 1, self.num_mask_tokens), :, :]
        # print(masks_hq.size())
