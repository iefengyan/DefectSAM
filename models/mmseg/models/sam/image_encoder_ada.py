...
class MultiScaleAdapter(nn.Module):
    def __init__(self, D_features, skip_connect=True):
        ...
        self.mlp=nn.Sequential(
            nn.Conv2d(D_features,D_features//16,1,bias=False),
            LayerNorm2d(D_features//16),
            nn.GELU(),
            nn.Conv2d(D_features//16,D_features,1,bias=False)
        )
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.msc_Adapter = MultiScaleAdapter(dim)
